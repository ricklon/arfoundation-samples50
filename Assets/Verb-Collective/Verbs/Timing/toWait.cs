...
public class toWait : Verb {
    ...
    [Tooltip("Set the number of second you want to pass before triggering, you can use decimals")]
    ...
    void Update () {
		...
		if(isActive)
		{
			...
			{
                //Deactivate this verb and activate the ones set to trigger at the end of the timer 
                timePassed = 0.0f;
                isActive = false;
